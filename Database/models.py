from sqlalchemy import ForeignKey, Column, Integer, String, Time, Boolean
...
class book(Base):
    ...
    subject = Column(String(50), ForeignKey('subjects.subject', ondelete="CASCADE"), nullable=True)
